...
│   ├── switches/
│   │   ├── Core-Switch.txt
│   │   ├── Distribution-SW1.txt
│   │   ├── Distribution-SW2.txt
│   │   ├── Access-SW-Finance.txt
│   │   ├── Access-SW-HR.txt
│   │   ├── Access-SW-IT.txt
│   │   └── Access-SW-Management.txt
│   └── wireless/
│       └── AP-Config-Notes.txt
│
├── addressing/
│   ├── ip-addressing-table.md      ← Full IP/subnet plan
│   └── vlan-table.md               ← VLAN assignments
│
├── docs/
│   ├── project-report.md           ← Full technical write-up
│   ├── technologies-used.md        ← Technology breakdown
│   └── testing-results.md         ← Ping tests & verification
│
└── diagrams/
    ├── network-flow.md              ← Data flow walkthrough
